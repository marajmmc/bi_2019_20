...
if(isset($CI->permissions['action2']) && ($CI->permissions['action2']==1))
{
    ...
    (
        ...
        'label'=>'File Upload',
        'class'=>'button_jqx_action',
        'data-action-link'=>site_url($CI->controller_url.'/index/add_image')
    );
    /*$action_buttons[]=array
    (
        'type'=>'button',
        ...
        $("#system_jqx_container").jqxGrid(
            {
               ...
               /* rowsheight: 35,
                ...
                columns:
                [
                    { text: '<?php echo $CI->lang->line('LABEL_EVENT_ID'); ?>', dataField: 'id',width:'50',cellsAlign:'right',hidden: <?php echo $system_preference_items['id']?0:1;?>},

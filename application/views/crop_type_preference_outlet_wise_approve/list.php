        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CROP_NAME'); ?>', dataField: 'crop_name', width: '100', filtertype: 'list', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['crop_name']?0:1;?>},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_REQUESTED_BY'); ?>', dataField: 'requested_by', width: '200', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['requested_by']?0:1;?>}
                ]
            });
    });
</script>
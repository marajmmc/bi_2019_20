...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_delete');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-6">
                <div class="panel panel-default">
                    ...
                    <div id="accordion_assign_group" class="panel-collapse collapse out">
            ...
            <div class="col-xs-6">
                <div class="panel panel-default">
                    ...
                    <div id="accordion_link_url" class="panel-collapse collapse out">
                        <table class="table table-responsive table-bordered">
                            <thead>
                            <tr>
        ...
        <div class="row show-grid">
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div id="accordion_file_image" class="panel-collapse collapse out">
                        <div class="row show-grid">
                            <table class="table table-responsive table-bordered">
                                <thead>
                                <tr>
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right">Delete Status<span style="color:#FF0000">*</span></label>
            </div>

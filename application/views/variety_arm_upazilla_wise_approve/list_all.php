        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CREATED_BY'); ?>', dataField: 'created_by', width: '180', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['created_by']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_CREATED_TIME'); ?>', dataField: 'created_time', width: '180', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['created_time']?0:1;?>},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_FORWARDED_TIME'); ?>', dataField: 'forwarded_time', width: '180', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['forwarded_time']?0:1;?>},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_APPROVED_BY'); ?>', dataField: 'approved_by', width: '180', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['approved_by']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_APPROVED_TIME'); ?>', dataField: 'approved_time', width: '180', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['approved_time']?0:1;?>}
                ]
            });
    });
</script>
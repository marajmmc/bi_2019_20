        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_REQUESTED_BY'); ?>', dataField: 'requested_by', width: '120', filtertype: 'none', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['requested_by']?0:1;?>}
                ]
            });
    });
</script>
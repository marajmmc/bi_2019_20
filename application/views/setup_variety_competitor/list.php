        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_COMPETITOR_NAME'); ?>', dataField: 'competitor_name', width: '150', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['competitor_name']?0:1;?>},

...
class Setup_variety_major_competitor extends Root_Controller
{
    ...
    private function language_labels()
    {
        ...
        $this->lang->language['LABEL_VARIETY_COMPETITOR_EXISTING']='Exiting Competitor Major Variety';
        $this->lang->language['LABEL_VARIETY_COMPETITOR_EDITED']='Edited Competitor Major Variety';
    ...
    private function system_edit($id)
    {
        if (isset($this->permissions['action1']) && ($this->permissions['action1'] == 1))
        {
            ...
            //$this->db->where('v.crop_type_id',$item_id);
            ...
            foreach($results as $result)
            {
                ...
                {
                    $data['variety_competitor'][]=$result;
                }
            }
